...
public class ClubSimulation {
   ...
   //static Barman andrea;
	...
	public static void setupGUI(int frameX,int frameY,int [] exits) {
		...
		startB.addActionListener(new ActionListener() {
		    public void actionPerformed(ActionEvent e)  {
                  ...
                  synchronized (Clubgoer.startObj) {
                      Clubgoer.startObj.notifyAll();
                  }
         ...
         public void actionPerformed(ActionEvent e) {
              ...
              Clubgoer.pause = !Clubgoer.pause;
      
              // If pause is being turned off, notify all waiting threads to resume
              if (!Clubgoer.pause) {
                  synchronized (Clubgoer.club) {
                      Clubgoer.club.notifyAll();
                  }
              }
          }
         });
	...
	public static void main(String[] args) throws InterruptedException {
      ...
      /*PeopleLocation barPersonLoc = new PeopleLocation(999);
      andrea = new Barman(999,barPersonLoc);
      Clubgoer.andrea = andrea;*/
	   ...
	   peopleLocations = new PeopleLocation[noClubgoers];
		...
		setupGUI(frameX, frameY,exit);  //Start Panel thread - for drawing animation
            //clubView.setBarpersonLocation(barPersonLoc);
